    ...
    render() {
        ...
        let form = (
            <Form onSubmit={this.submitHandler}>
                <Form.Group className="form-content" as={Row} noGutters="true">
                ...
                <Form.Group className="form-content">
                    <Form.Group as={Row} noGutters="true">
                        ...
                        <Col as={Row} sm="6" noGutters="true">
                            ...
                            <Col as={Row} sm="6" noGutters="true">
                                <Form.Group as={Row} sm="12" noGutters="true">
                ...
                <Form.Group className="form-content" style={{marginBottom: 0}}>
                    <Form.Group as={Row} noGutters="true">
                        ...
                        <Col sm="5" as={Row} noGutters="true">
        ...
        return (
            <div>
                ...
                <Button className="margin-top-5 submit-btn" disabled={!this.state.editable}>ویرایش</Button>
